{*
   ...
   {if !empty($homeslider.slides)}
               ...
               <a href="{$slide.url}">
                 ...
                 {if $slide.title || $slide.description }
                   ...
                   <span class="homeslider__caption">
                     <h4 class="homeslider__subheader">{$slide.legend}</h4>
                     <h3 class="homeslider__title">{$slide.title nofilter}</h3>
                     <div class="homeslider__desc">{$slide.description nofilter}</div>
                     <div class="btn-all-wrapper">
                       <button class="btn btn-secondary btn-all">
                         Sprawdź ofertę
                       </button>
                     </div>
                   </span>
     ...
     {hook h='displayHomepageConfigurator' }
   {/if}